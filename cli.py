...
def cmd_prognosis(args):
    ...
    argv += ["--max-forcing-strength", str(args.max_forcing_strength)]
    argv += ["--n-timepoints", str(args.n_timepoints)]
...
def build_parser():
    ...
    s.add_argument("--classifier", choices=["correlation", "modern_hopfield", "both"],
                   default="correlation")
    ...
    s.add_argument("--group-col", choices=["predicted_cms", "modern_hopfield_cms"],
    ...
    s.add_argument("--n-timepoints", type=int, default=10)
    s.add_argument("--output")
